...
echo #define %app_name%_VERSION_BUILD           %git_ver% >>%header_file_location%  2>&1 
echo #define %app_name%_VERSION_STRING          "%MAJOR_VERSION%.%MINOR_VERSION%.%REVISION_VERSION%.%git_ver%" >>%header_file_location%  2>&1 
echo #define %app_name%_VERSION_STRING_EX       "%app_name_lowercase% version:%MAJOR_VERSION%.%MINOR_VERSION%.%REVISION_VERSION%.%git_ver% build at %date:~0,4%-%date:~5,5% %time:~0,8%" >>%header_file_location%  2>&1 

...
echo %app_name_lowercase%_version %MAJOR_VERSION%.%MINOR_VERSION%.%PATCH_VERSION%.%GIT_VERSION_COMMIT%(%GIT_VERSION%)
...
echo #define %app_name%_VERSION_PATCH           %PATCH_VERSION% >>%header_file_location%  2>&1 
echo #define %app_name%_VERSION_REVISION        %GIT_VERSION_COMMIT% >>%header_file_location%  2>&1 
echo #define %app_name%_VERSION_STRING          "%MAJOR_VERSION%.%MINOR_VERSION%.%PATCH_VERSION%.%GIT_VERSION_COMMIT%(%GIT_VERSION%)" >>%header_file_location%  2>&1 
echo #define %app_name%_VERSION_STRING_EX       "%app_name_lowercase% version:%MAJOR_VERSION%.%MINOR_VERSION%.%PATCH_VERSION%.%GIT_VERSION_COMMIT%(%GIT_VERSION%) build at %date:~0,4%-%date:~5,5% %time:~0,8%" >>%header_file_location%  2>&1 
